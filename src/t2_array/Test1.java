...
public class Test1 {
	public static void main(String[] args) {
		int	atom = 0; //기본타입 초기값 안주면 뭐가 들어가있는지 모른다.
		//int atom; 뭐가 들어있는지 모른다.
...
//		int[] mbc;
//		mbc = new int[5]; //mbc를 5개방으로 만들겠다.
		
		int[] mbc = new int[5]; //위아래 둘다가능 double 타입이면 초기값을 안넣어도 초기값 0.0, boolean 타입이면 초기값 false, 참조타입이면 null
		...
		int[] sbs3 = {100,30,80,50,90}; // 생성연산자 뒤에 지워도 실행됨
